...
export { registerFrame, frameWiringKey, depositDispatchCapability } from './registerFrame.js';   // REF-1.1 E1: the one canonical frame-registration door; E2.0: (wire,transportKind) key; E3: capability-channel deposit (write-only)
