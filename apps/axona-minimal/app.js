...
import { AxonaPeer, AxonaDomain, NeuronNode, createNodeIdentity, createAuthorIdentity, deriveTopicId, KERNEL_VERSION } from '/src/index.js?v=0.17.0';
import { webTransport } from '/src/transport/web/index.js?v=0.17.0';
import { regionName }   from '/src/utils/region-names.js?v=0.17.0';
import { resolveAnchor } from '../lib/region.js?v=0.17.0';
import { makeMessage, readMessage } from '/std/message.js?v=0.17.0';
