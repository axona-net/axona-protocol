...
import { connectAxona, KERNEL_VERSION, REGION } from './axona.js?v=0.18.0';
...
import { createReassembler, publishChunkedBytes } from '/std/chunk.js?v=0.18.0';
import { compressImage } from '../lib/image.js?v=0.18.0';

const APP_VERSION = '0.18.0';     // chunks via kernel std/chunk v3.6.0 (reliable publish: verify+repair).
