...
import { connectAxona, KERNEL_VERSION, REGION } from './axona.js?v=4.68.2';
...
import { createReassembler, publishChunkedBytes } from '/std/chunk.js?v=4.68.2';
import { compressImage } from '../lib/image.js?v=4.68.2';
