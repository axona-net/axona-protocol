...
import { AxonaPeer, AxonaDomain, NeuronNode, createNodeIdentity, createAuthorIdentity, deriveTopicId, KERNEL_VERSION } from '/src/index.js?v=4.75.2';
import { webTransport } from '/src/transport/web/index.js?v=4.75.2';
import { regionName }   from '/src/utils/region-names.js?v=4.75.2';
import { resolveAnchor } from '../lib/region.js?v=4.75.2';
import { makeMessage, readMessage } from '/std/message.js?v=4.75.2';
